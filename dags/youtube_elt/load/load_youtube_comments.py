...
df = spark.readStream \
    ...
    .option("subscribe", "youtube_comments_data") \
...
df_selected = df_selected.withColumn("like_count", col("like_count").cast("int"))

query = df_selected.writeStream \
    .partitionBy("year", "month", "day") \
    .format("parquet") \
    .option("path", "hdfs://namenode1:9000/youtube_DE_project/datalake/youtube_comments/raw/") \
    .option("checkpointLocation", "hdfs://namenode1:9000/youtube_DE_project/datalake/youtube_comments/raw_checkpoint/") \
    .outputMode("append") \
    .trigger(once=True) \
    .start()
