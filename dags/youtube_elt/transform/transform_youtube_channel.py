...
spark = SparkSession.builder \
    .appName("YoutubeChannelTransformToHive") \
...
try:
    ...
    df = spark.read.parquet("hdfs://namenode1:9000/youtube_DE_project/datalake/youtube_channel/raw/") 
    ...
    df.write.mode("append") \
      ...
      .format("parquet") \
      .option("path", "hdfs://namenode1:9000/youtube_DE_project/datawarehouse/youtube_project_analytics/channel_data_analytics") \
      .saveAsTable("youtube_project_analytics.channel_data_analytics")
